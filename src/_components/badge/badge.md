...
<span class="badge text-transform--uppercase"><small>Small text</small></span> <span class="badge bg--native">Native</span> <span class="badge bg--greendark fontsize-xxsmall">Greendark xxsmall</span> <span class="badge text-transform--uppercase">Badge with icon <i class="fa fal fa-trash"></i></span>
